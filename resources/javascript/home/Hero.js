...
const telegramIcon = (
    <svg xmlns="http://www.w3.org/2000/svg" width={SIZE} height={SIZE} fill="currentColor" className="bi bi-telegram"
         viewBox="0 0 16 16">
        <path
...
const linkedinIcon = (
    <svg xmlns="http://www.w3.org/2000/svg" width={SIZE} height={SIZE} fill="currentColor" className="bi bi-linkedin"
         viewBox="0 0 16 16">
        <path
